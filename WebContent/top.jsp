...
<%
	...
	String sql = "select * from item where category in('sleeveless','tshirt','knit')";
...
<body>
	...
	<div id="main">												<!-- 메인 내용 -->
		...
		<div class="content">							<!-- 내용부분 -->
			<div class=menuname>
			<a href="top.jsp" style="text-decoration:none;">TOP</a></div>
			<div class="detail" style="color:#1C1C1C;">
				<a href="sleeveless.jsp">SLEEVELESS</a>
				<a href="tshirt.jsp">T-SHIRTS</a>
				<a href="knit.jsp">KNIT</a>
			</div>
			<%
