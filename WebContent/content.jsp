...
<%
	...
	String st_qna_num=request.getParameter("qna_num");
	int qna_num = Integer.parseInt(st_qna_num);
	int message = 0;
	...
	String sql="select * from qna where qna_num ='"+qna_num+"'";
	ResultSet rs = null;
%>
<html>
<head>
...
<body>
	...
	<div style="padding:0px 0px 300px;">							<!-- 스크롤 -->
		...
		<br>
	  		<input type="button" class="btn" value="글삭제" onclick="location.href='deleteform.jsp?qna_num=<%=qna_num%>'">
       		<input type="button" class="btn" value="글목록" onclick="location.href='qna.jsp'">
	</form>
	</div> 
	</div>
	</div>
