...
<script type="text/javascript">  
  ...
  function deleteSave(){	
	if(!"admin".equals((String)session.getAttribute("id"))&&!document.delForm.passwd.value){
	   alert("비밀번호를 입력하세요.");
...
<body>
	...
	<div style="padding:0px 0px 300px;">							<!-- 스크롤 -->
		...
		<form method="POST" name="delForm" action="deletePro.jsp?qna_num=<%=qna_num%>" onsubmit="return deleteSave()"> 
 		<h4>비밀번호를 입력해주세요.</h4>
 		<div class="pw">
 		<label>비밀번호 :   </label>
