...
<%
	...
	String sql = "select * from item where category in('bag','harness&lead')";
...
<body>
	...
	<div id="main">												<!-- 메인 내용 -->
		...
		<div class="content">							<!-- 내용부분 -->
			<div class=menuname>
			<a href="goout.jsp" style="text-decoration:none;">GO OUT</a></div>
			<div class="detail" style="color:#1C1C1C;">
			<a href="harnlead.jsp">HARNESS&LEAD</a>
