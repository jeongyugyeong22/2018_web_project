...
<%
	...
	String sql = "select * from item where category in('hairpin','muffler')";
...
<body>
	...
	<div id="main">												<!-- 메인 내용 -->
		...
		<div class="content">							<!-- 내용부분 -->
			<div class=menuname>
			<a href="acc.jsp" style="text-decoration:none;">ACC</a></div>
			<div class="detail" style="color:#1C1C1C;">
			<a href="hairpin.jsp">HAIR PIN</a>
			<a href="muffler.jsp">MUFFLER</a>
			</div>
			<%
