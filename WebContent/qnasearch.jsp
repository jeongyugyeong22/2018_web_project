...
<%
	...
	String sql_all = "select * from qna";
	String sql="";
	...
	if(keyword.equals("")){
		...
		sql = "select * from qna where mem_name LIKE '%" + keyword + "%'";
	}
			...
			%>
       		...
       		<!--  검색 --> 
 				<tr style="text-align: center;"> 
 					<td colspan="5"> 
 						<form name ="qnasearch" action="qnasearch.jsp" method="post"> 
							...
							var selected = searchName.options[searchName.selectedIndex].value;
							</script>
