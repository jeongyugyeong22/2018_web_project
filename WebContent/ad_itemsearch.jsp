...
<%
	...
	else if(searchName.equals("category")){
		sql = "select * from item where category LIKE '%" + keyword + "%'";
	}
	else if(searchName.equals("color")){
		sql = "select * from item where color LIKE '%" + keyword + "%'";
	}
