...
<%
	...
	String st_notice_num=request.getParameter("notice_num");
	int notice_num = Integer.parseInt(st_notice_num);
	int message = 0;
	...
	String sql="select * from notice where notice_num ='"+st_notice_num+"'";
	ResultSet rs = null;
%>
<html>
<head>
...
<body>
	...
	<div style="padding:0px 0px 300px;">							<!-- 스크롤 -->
		...
		<div class="content">
		<div class=menuname>
			<a href="notice.jsp" style="text-decoration:none;">NOTICE</a>
		</div> 
		<form>
		...
		<br>
	  		<input type="button" class="btn" value="글삭제" onclick="location.href='noticedeleteform.jsp?notice_num=<%=notice_num%>'">
       		<input type="button" class="btn" value="글목록" onclick="location.href='notice.jsp'">
	</form>
	</div> 
	</div>
	</div>
