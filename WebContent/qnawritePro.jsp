...
String qna_pw=request.getParameter("pw");
...
try
	{
		...
		PreparedStatement stmt = Conn.prepareStatement("select max(qna_num) from qna");
		...
		String sql_save="insert into qna (qna_num,qna_pw,id,mem_name,title,content) values ('"+num+"','"+qna_pw+"','"+id+"','"+mem_name+"','"+title+"','"+content+"')";
...
<form name="frm" method="post" action="content.jsp?qna_num=<%=num%>">
