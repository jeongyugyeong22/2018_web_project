...
<%
	...
	String sql = "select * from item where category in('padding','cardigan')";
...
<body>
	...
	<div id="main">												<!-- 메인 내용 -->
		...
		<div class="content">							<!-- 내용부분 -->
			<div class=menuname>
			<a href="outer.jsp" style="text-decoration:none;">OUTER</a></div>
			<div class="detail" style="color:#1C1C1C;">
			<a href="padding.jsp">PADDING</a>
			<a href="cardigan.jsp">CARDIGAN</a>
			</div>
			<%
